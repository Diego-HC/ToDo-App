...
export default function NavBar() {
  ...
  return (
    <div className="flex h-20 min-h-[5rem] w-full items-center bg-slate-800 text-xl">
      ...
      <div className="mx-8 flex w-full items-center justify-end">
        {/* If session data, place an image of the user */}
          ...
          <div className="flex items-center justify-end">
            <div className="flex items-center">
              ...
              <div className="relative lg:right-28">
                <dialog
                  className={"w-28 rounded-md bg-white p-5 shadow-md shadow-black lg:top-8" + (dialogOpen ? " visible transition ease-in-out delay-0 translate-y-1 scale-110 duration-100" : "")}
                  id="profileDialog"
                >
                  <div className="flex flex-col items-center justify-start text-base">
                    {/* <Link href="/groups" className="pb-3">
                      <p>My Groups</p>
                    </Link> */}
        ...
        <div className="relative flex items-center">
          ...
          >
            ...
            >
              ...
              <span className="bg-danger absolute -mt-4 ml-2.5 rounded-full px-[0.35em] py-[0.15em] text-[0.6rem] font-bold leading-none text-white">
                1
              </span>
            </a>
            <ul
